...
public class OrderController {
    ...
    @GetMapping("/orders")
    public ResponseEntity<List<Order>> getAllOrders(@RequestParam(required = false) String quantity) {
        try {
            ...
            if (quantity == null)
                ...
                orderRepository.findByQuantityContaining(quantity).forEach(orders::add);
    ...
    public ResponseEntity<Order> createOrder(@RequestBody Order order) {
        try {
            ...
            Order _order = orderRepository
                    .save(new Order(order.getCusid(),order.getItemid(),order.getQuantity(), order.getDescription(),order.getAmount(),false,timestamp));
